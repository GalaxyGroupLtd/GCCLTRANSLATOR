...
public class MessageAdapter extends RecyclerView.Adapter<MessageAdapter.MyViewHolder> {
    private OnMessageAdapter mListener;
    private Context context;
    private List<Object> mMessageContent;
    private List<Object> tempList;

    public MessageAdapter(OnMessageAdapter mListener, Context context, List<Object> mMessageContent) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        holder.icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mListener.onMessageAdapter(true, holder.title, mContent, ExtraConfig.MESSAGE_PLAY);
            }
        });
    ...
    private void buildMenu(View view, Object object) {
        ...
        inflater.inflate(R.menu.message_menu, popup.getMenu());
    ...
    public interface OnMessageAdapter {
        void onMessageAdapter(boolean isClicked, View view, Object object, String action);
    }
    ...
    class MyMenuItemClickListener implements PopupMenu.OnMenuItemClickListener {
        ...
        public boolean onMenuItemClick(MenuItem menuItem) {
            switch (menuItem.getItemId()) {
                case R.id.favorite:
                    mListener.onMessageAdapter(true, null, object, ExtraConfig.MESSAGE_FAVORITE);
                    return true;
                case R.id.play:
                    mListener.onMessageAdapter(true, null, object, ExtraConfig.MESSAGE_PLAY);
                    return true;
                case R.id.info:
                    mListener.onMessageAdapter(true, null, object, ExtraConfig.MESSAGE_INFO);
                    return true;
                default:
            }
            return false;
